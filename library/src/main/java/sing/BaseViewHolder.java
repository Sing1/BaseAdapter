...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public <T extends View> T getView(int viewId) {
        View view = views.get(viewId);// 先从缓存中找
        if (view == null) {
            view = itemView.findViewById(viewId);// 直接从ItemView中找
    ...
    // 设置控件点击事件
    public void setOnChildClickListener(int viewId, View.OnClickListener listener) {
    ...
    // 图片加载，这里稍微处理得复杂一些，因为考虑加载图片的第三方可能不太一样也可以不写这个类
